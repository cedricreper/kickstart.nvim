...
function M.setup(c, config)
    ...
    local groups = {
        ...
        -- Status line
        StatusLine = { fg = c.statusbar_fg, bg = config.transparencies.statusline and "NONE" or c.ui_bg },
        StatusLineNC = { fg = c.gray3, bg = config.transparencies.statusline and "NONE" or c.ui_bg },
        StatusLineTerm = { fg = c.statusbar_fg, bg = config.transparencies.statusline and "NONE" or c.ui_bg },
        StatusLineTermNC = { fg = c.gray3, bg = config.transparencies.statusline and "NONE" or c.ui_bg },
        ...
        SnacksIndentScope = { fg = c.gray6, nocombine = true },
